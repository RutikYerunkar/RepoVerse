...
export async function askQuestion(question: string, projectId: string) {
  ...
  (async () => {
    const { textStream } = await streamText({
      ...
      prompt: `
    You are a ai code assistant who answers questions about the codebase. Your target audience is a technical intern with a basic understanding of programming and software development.
    ...
    If the question is asking about code or a specific file, AI will provide the detailed answer, giving step by step instructions and explanations as needed.
